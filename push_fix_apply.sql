-- ============================================================
-- LearningFans: fix the bell + web push (2 migrations, idempotent)
-- 20260811000000 first (creates notifications + user_stats), then
-- 20260812000003 (push_subscriptions + notifications.push_sent_at).
-- Paste into: https://supabase.com/dashboard/project/xhximqrchwwwwwsysgdo/sql/new
-- Safe to re-run on error.
-- ============================================================
